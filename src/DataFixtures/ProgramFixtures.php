    ...
    private const PROGRAMMES = [
        ...
        public function load(ObjectManager $manager): void
        {
            foreach (self::PROGRAMMES as $programDescription) {
                ...
                $program->setCategory($this->getReference('category_'.$programDescription['category']));
